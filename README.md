...
- **Nicolau et al. (2011)**: "Topology based data analysis identifies a subgroup of breast cancers with a unique mutational profile and excellent survival" — _PNAS_, 108(17):7265-7270
- **Singh, Memoli, & Carlsson (2007)**: "Topological methods for data analysis and visualization of high-dimensional datasets" — _IEEE Symposium on Information Visualization_
- **Carlsson, G. (2009)**: "Topology and data" — _Bulletin of the American Mathematical Society_
